...
anymatch('node_modules', indexjs.jss'); // false
anymatch('node_modules/**'indexjs.js.js'); // true
anymatch('node_modules/*indexjs.jsjs.js'); // false
anymatch('**/node_modulesindexjs.jsexjs.js'); // true
```
